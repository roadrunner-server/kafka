...
func (p *Plugin) ConsumerFromConfig(_ string, _ priorityqueue.Queue) (jobs.Consumer, error) {
	return nil, errors.Str("kafka driver is not available under Windows OS, please, use WSL2/Linux/MacOS")
}
...
func (p *Plugin) ConsumerFromPipeline(_ *pipeline.Pipeline, _ priorityqueue.Queue) (jobs.Consumer, error) {
	return nil, errors.Str("kafka driver is not available under the Windows OS, please, use WSL2/Linux/MacOS")
}
